...
/** For the OAS workaround where the "grouped endpoints" yaml file (e.g. tax_liability_adjustments.yaml) must include the matching summary text for
  * each endpoint. This rewriter uses handlebars and config to add [test only] if necessary.
  */
