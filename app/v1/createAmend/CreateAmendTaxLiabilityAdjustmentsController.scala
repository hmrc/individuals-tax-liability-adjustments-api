...
@Singleton
class CreateAmendTaxLiabilityAdjustmentsController @Inject(
    val authService: EnrolmentsAuthService,
    val lookupService: MtdIdLookupService,
    service: CreateAmendTaxLiabilityAdjustmentsService,
    validatorFactory: CreateAmendTaxLiabilityAdjustmentsValidatorFactory,
