...
@Singleton
class DeleteTaxLiabilityAdjustmentsController @Inject() (val authService: EnrolmentsAuthService,
                                                         val lookupService: MtdIdLookupService,
                                                         service: DeleteTaxLiabilityAdjustmentsService,
                                                         validatorFactory: DeleteTaxLiabilityAdjustmentsValidatorFactory,
    ...
    authorisedAction(nino).async { implicit request =>
      ...
      val requestHandler =
        RequestHandler
          ...
          .withService(service.deleteTaxLiabilityAdjustments)
