...
class TaxLiabilityAdjustmentsAuthSupportingAgentsAllowedISpec extends AuthSupportingAgentsAllowedISpec {

  val callingApiVersion = "1.0"

  val supportingAgentsAllowedEndpoint = "create-amend-tax-liability-adjustments"

  val mtdUrl = s"/$nino/2026-27"
